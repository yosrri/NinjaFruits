...
public class Banana extends Fruits implements IDrops {
    ...
    public ImageView getImage() {
        ...
        File file = new File("/Users/ahmedtharwatwagdy/Documents/java/workspace/Fruit Ninja/src/fruit0.png");
        try {
    ...
    public ImageView getHalfImage() {
        ...
        File file = new File("/Users/ahmedtharwatwagdy/Documents/java/workspace/Fruit Ninja/src/fruit0S1.png");
        try {
            img = ImageIO.read(file);
        } catch (IIOException e) {
            e.printStackTrace();
    ...
    public ImageView getSecHalfImage() {
        ...
        File file = new File("/Users/ahmedtharwatwagdy/Documents/java/workspace/Fruit Ninja/src/fruit0S2.png");
        try {
            img = ImageIO.read(file);
        } catch (IIOException e) {
            e.printStackTrace();
